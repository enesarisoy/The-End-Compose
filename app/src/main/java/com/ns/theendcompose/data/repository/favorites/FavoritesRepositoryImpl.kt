...
import com.ns.theendcompose.data.local.db.movie.FavoritesMoviesDao
import com.ns.theendcompose.data.local.db.tvshow.FavoritesTvShowsDao
...
class FavoritesRepositoryImpl @Inject constructor(
    ...
    override fun getFavoriteMoviesIds(): Flow<List<Int>> {
        return favoritesMoviesDao.favoriteMoviesIds().distinctUntilChanged()
    }
    ...
    override fun getFavoriteMoviesCount(): Flow<Int> {
        return favoritesMoviesDao.favoriteMoviesCount().distinctUntilChanged()
    }
